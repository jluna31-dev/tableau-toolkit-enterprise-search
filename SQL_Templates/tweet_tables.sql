CREATE VIEW tweet_info AS SELECT
...
CREATE VIEW hashtag_info AS SELECT
tweetID,
hashtags_json ->> 'text' AS hashtag
FROM hashtags_query;

CREATE VIEW annotations_info AS SELECT
tweetID,
